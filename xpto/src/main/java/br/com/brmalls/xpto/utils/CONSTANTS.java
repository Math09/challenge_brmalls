...
public class CONSTANTS {
    ...
    public static final String DATA_RECEIVED = "Data received from Tax Service: {}";

    public static final String RESPONSE_NO = "No response from 'Receita WS' for the CNPJ: {}";
